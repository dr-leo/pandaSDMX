...
- A :class:`MaintainableArtefact` is under the authority of a particular
  ...
  the object might only be a reference (
  :attr:`is_external_reference <MaintainableArtefact.is_external_reference>`),
  in which case a :attr:`structure_url <MaintainableArtefact.structure_url>`
  might be given where more information about the object can be obtained. It is
  versionable, nameable, and identifiable.
